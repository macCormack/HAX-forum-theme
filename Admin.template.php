...
function template_admin()
{
	...
	echo '
						<div id="admin_main_section" class="support-section">';
	...
	echo '
							<div id="supportVersionsTable" class="align-right">
								<h3 class="category_header">
...
function template_admin_search_results()
{
	...
	echo '
					<div class="category_header">
						<h3 class="cat-title-left hdicon cat_img_search">', sprintf($txt['admin_search_results_desc'], $context['search_term']), '</h3>
