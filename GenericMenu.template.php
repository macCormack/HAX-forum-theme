...
function template_generic_menu_sidebar_above()
{
	...
	<div id="main_container" class="main-container">
		<div id="menu_sidebar" class="menu-sidebar">';
...
function template_generic_menu_tabs(&$menu_context)
{
	...
	{
		echo '
					<div class="category_header flexed">';
	...
	if (!empty($tab_context['tabs']))
	{
		...
		foreach ($tab_context['tabs'] as $sa => $tab)
		{
			...
			if (!empty($tab['is_selected']))
				echo '
						<li class="listlevel1">
							<a class="btn active" href="', isset($tab['url']) ? $tab['url'] : $menu_context['base_url'] . ';area=' . $menu_context['current_area'] . ';sa=' . $sa, $menu_context['extra_parameters'], isset($tab['add_params']) ? $tab['add_params'] : '', '">', $tab['label'], '</a>
						</li>';
			else
				echo '
						<li class="listlevel1">
							<a class="btn" href="', isset($tab['url']) ? $tab['url'] : $menu_context['base_url'] . ';area=' . $menu_context['current_area'] . ';sa=' . $sa, $menu_context['extra_parameters'], isset($tab['add_params']) ? $tab['add_params'] : '', '">', $tab['label'], '</a>
						</li>';
		}
